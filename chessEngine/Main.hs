...
--main = do{
--        displayBoard (snd (bs1));
--        displayBoard (snd (bs2));
--        print (genMovesString bs1 bs2);
--    }
--    where
--        gs1 = playGameUsingHistory initialGameState moves1
--        gs2 = playGameUsingHistory initialGameState moves2
--        bs1 = fst gs1
--        bs2 = fst gs2
--        moves1 = ["e2e4", "d7d5" , "e4d5", "c7c6", "d5c6", "b7b6", "c6c7", "b6b5"]
--        moves2 = ["e2e4", "d7d5" , "e4d5", "c7c6", "d5c6", "b7b6", "c6c7", "b6b5", "c7b8q"]
